...
builder.Services.AddDbContext<RocketseatAuctionDbContext>(options =>
{
    ...
    options.UseSqlite($@"Data Source=C:\Users\{UserName}\nlw-expert-c-sharp\{Environment.GetEnvironmentVariable("DB_NAME")}.db");
});
    ...
    app.UseSwaggerUI(c =>
{
    ...
    c.SwaggerEndpoint("../swagger/v1/swagger.json", "Rocketseat Auction");
});
}
